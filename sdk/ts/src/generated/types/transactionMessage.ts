...
export function getTransactionMessageEncoder(): FixedSizeEncoder<TransactionMessageArgs> {
...
export function getTransactionMessageDecoder(): FixedSizeDecoder<TransactionMessage> {
...
export function getTransactionMessageCodec(): FixedSizeCodec<
