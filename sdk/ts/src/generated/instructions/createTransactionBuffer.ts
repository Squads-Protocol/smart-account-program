...
export const CREATE_TRANSACTION_BUFFER_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([57, 97, 250, 156, 59, 211, 32, 208]);

export function getCreateTransactionBufferDiscriminatorBytes(): ReadonlyUint8Array {
