...
export const CLOSE_SETTINGS_TRANSACTION_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([251, 112, 34, 108, 214, 13, 41, 116]);

export function getCloseSettingsTransactionDiscriminatorBytes(): ReadonlyUint8Array {
