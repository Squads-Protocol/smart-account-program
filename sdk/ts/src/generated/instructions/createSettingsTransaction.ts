...
export const CREATE_SETTINGS_TRANSACTION_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([101, 168, 254, 203, 222, 102, 95, 192]);

export function getCreateSettingsTransactionDiscriminatorBytes(): ReadonlyUint8Array {
