...
export const ADD_SPENDING_LIMIT_AS_AUTHORITY_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([169, 189, 84, 54, 30, 244, 223, 212]);

export function getAddSpendingLimitAsAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
