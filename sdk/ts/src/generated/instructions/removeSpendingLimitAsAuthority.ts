...
export const REMOVE_SPENDING_LIMIT_AS_AUTHORITY_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([94, 32, 68, 127, 251, 44, 145, 7]);

export function getRemoveSpendingLimitAsAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
