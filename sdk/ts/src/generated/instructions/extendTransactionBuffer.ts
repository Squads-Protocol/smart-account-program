...
export const EXTEND_TRANSACTION_BUFFER_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([190, 86, 246, 95, 231, 154, 229, 91]);

export function getExtendTransactionBufferDiscriminatorBytes(): ReadonlyUint8Array {
