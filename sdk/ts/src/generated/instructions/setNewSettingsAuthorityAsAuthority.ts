...
export const SET_NEW_SETTINGS_AUTHORITY_AS_AUTHORITY_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([221, 112, 133, 229, 146, 58, 90, 56]);

export function getSetNewSettingsAuthorityAsAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
...
> {
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta("settingsAuthority", accounts.settingsAuthority),
