...
export const CHANGE_THRESHOLD_AS_AUTHORITY_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([51, 141, 78, 133, 70, 47, 95, 124]);

export function getChangeThresholdAsAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
