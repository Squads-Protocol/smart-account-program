...
export const REMOVE_SIGNER_AS_AUTHORITY_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([58, 19, 149, 16, 181, 16, 125, 148]);

export function getRemoveSignerAsAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
