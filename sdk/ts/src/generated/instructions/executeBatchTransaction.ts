...
export const EXECUTE_BATCH_TRANSACTION_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([237, 67, 201, 173, 33, 130, 88, 134]);

export function getExecuteBatchTransactionDiscriminatorBytes(): ReadonlyUint8Array {
