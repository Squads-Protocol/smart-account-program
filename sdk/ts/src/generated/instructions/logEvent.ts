...
export const LOG_EVENT_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  5, 9, 90, 141, 223, 134, 57, 217,
]);

export function getLogEventDiscriminatorBytes(): ReadonlyUint8Array {
...
>(
  ...
  return Object.freeze({
    accounts: [getAccountMeta("logAuthority", accounts.logAuthority)],
