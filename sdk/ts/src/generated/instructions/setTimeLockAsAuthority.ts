...
export const SET_TIME_LOCK_AS_AUTHORITY_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([2, 234, 93, 93, 40, 92, 31, 234]);

export function getSetTimeLockAsAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
