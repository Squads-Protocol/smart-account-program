...
export const USE_SPENDING_LIMIT_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([41, 179, 70, 5, 194, 147, 239, 158]);

export function getUseSpendingLimitDiscriminatorBytes(): ReadonlyUint8Array {
...
> {
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta("smartAccount", accounts.smartAccount),
      getAccountMeta("destination", accounts.destination),
      getAccountMeta("systemProgram", accounts.systemProgram),
      getAccountMeta("mint", accounts.mint),
      getAccountMeta(
        "smartAccountTokenAccount",
        accounts.smartAccountTokenAccount,
      ),
      getAccountMeta(
        "destinationTokenAccount",
