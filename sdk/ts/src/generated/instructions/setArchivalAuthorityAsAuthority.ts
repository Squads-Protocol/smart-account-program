...
export const SET_ARCHIVAL_AUTHORITY_AS_AUTHORITY_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([178, 199, 4, 13, 237, 234, 152, 202]);

export function getSetArchivalAuthorityAsAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
