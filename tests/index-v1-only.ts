// V1-only tests: runs parameterized tests with V1 signer format only.
// Used by: yarn testV1 (requires running validator)
process.env.SIGNER_FORMAT = "v1";

// Parameterized tests (will run V1 format only)
...
// V2-only tests excluded from V1 run
